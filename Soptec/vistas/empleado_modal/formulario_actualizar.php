  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title mx-auto" id="exampleModalLabel">Actualizar empleado</h5>
...
<form class="needs-validation" novalidate action="../../../back_end/controladores/empleado_controlador.php" method="GET" >
  ...
  <div class="form-row"> 
    ...
    <div class="col">
      ...
      <input type="text" class="form-control" id="validationCustom02" name="apellido1" value="<?php echo $empleado->apellido1?>" required>
    </div>

    <div class="col">
      <label for="validationCustom03">Apellido Materno</label>
      <input type="text" class="form-control" id="validationCustom03" name="apellido2" value="<?php echo $empleado->apellido2?>" required>
    </div>
  </div>
...
<!-------------------------------Precio, Cantidad, Status---------------------------------------->
  <div class="form-row">
    ...
    <div class="col-4">
      ...
      <input type="text" class="form-control" id="validationCustom04" name="puesto" value="<?php echo $empleado->puesto?>" required>
    </div>
    ...
    <div class="col-3">
      ...
      <input type="date" class="form-control" id="validationCustom05" name="fecha_ingreso" value="<?php echo $empleado->fecha_ingreso?>" required>
    </div>
...
<div class="form-row">
    ...
    <div class="col-3">
      ...
      <input type="text" class="form-control" id="validationCustom10" name="correo" value="<?php echo $empleado->correo?>" required>  
    </div>

    <div class="col-3">
      <label for="validationCustom09">Contraseña</label>
      <input type="password" class="form-control" id="validationCustom09" name="contrasena" value="<?php echo $empleado->contrasena?>" required>  
    </div>
  ...
  <!---- <button class="btn btn-primary" type="submit">Submit form</button>------->
      ...
      <input type="submit" class="col-8 btn btn-success mx-auto" value="Actualizar empleado">
